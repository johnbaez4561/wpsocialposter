								...
								<tbody>				
									<tr valign="top">
										...
										<td colspan="3">
											...
											<p><?php printf( esc_html__('You can get a step by step tutorial on how to create a Google Application on our %sDocumentation%s.', 'wpwautoposter' ), '<a href="'.esc_url('https://docs.wpwebelite.com/social-network-integration/google-youtube/').'" target="_blank">', '</a>' ); ?></p> 
										</td>
									</tr>
